    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          url = "https://api.thecatapi.com/v1/images/search?limit=30&breed_ids=".concat(selectedBreed);
          _context2.next = 5;
          return _axios.default.get(url);
        case 5:
          breedImagesResponse = _context2.sent;
          _context2.next = 8;
          return breedImagesResponse.data;
        case 8:
          ...
          //clear the carousel
          Carousel.clear();
          breedImages.forEach(function (element) {
            console.log(element);
...
function populateBreedInfo(breedData) {
  ...
  document.getElementById("breed-affection").textContent = breedData.affection_level;
  document.getElementById("breed-grooming").textContent = breedData.grooming;
  document.getElementById("breed-child-friendly").textContent = breedData.child_friendly;
  document.getElementById("breed-dog-friendly").textContent = breedData.dog_friendly;
  document.getElementById("breed-stranger-friendly").textContent = breedData.stranger_friendly;
  document.getElementById("breed-vocalization").textContent = breedData.vocalisation;
  document.getElementById("breed-temperament").textContent = breedData.temperament;
  document.getElementById("breed-health-issues").textContent = breedData.health_issues;
...
_axios.default.interceptors.request.use(function () {
  console.log(" Starting request to the server started");
});
_axios.default.interceptors.response.use(function () {
  console.log("Delay in getting a response; ".concat(startTime - Date.now(), " ms"));
});
