...
var _usingaxios = require("./usingaxios.js");
function _getRequireWildcardCache(e) { if ("function" != typeof WeakMap) return null; var r = new WeakMap(), t = new WeakMap(); return (_getRequireWildcardCache = function (e) { return e ? t : r; })(e); }
function _interopRequireWildcard(e, r) { if (!r && e && e.__esModule) return e; if (null === e || "object" != typeof e && "function" != typeof e) return { default: e }; var t = _getRequireWildcardCache(r); if (t && t.has(e)) return t.get(e); var n = { __proto__: null }, a = Object.defineProperty && Object.getOwnPropertyDescriptor; for (var u in e) if ("default" !== u && {}.hasOwnProperty.call(e, u)) { var i = a ? Object.getOwnPropertyDescriptor(e, u) : null; i && (i.get || i.set) ? Object.defineProperty(n, u, i) : n[u] = e[u]; } return n.default = e, t && t.set(e, n), n; }
...
},{"bootstrap":"node_modules/bootstrap/dist/js/bootstrap.esm.js","./usingaxios.js":"usingaxios.js"}],"node_modules/axios/lib/helpers/bind.js":[function(require,module,exports) {
'use strict';
...
exports.Axios = Axios;
},{"./lib/axios.js":"node_modules/axios/lib/axios.js"}],"usingaxios.js":[function(require,module,exports) {
"use strict";
...
var API_KEY = "live_bMH43Q9myZW23NhUScd4Z5vCyo4HCW6JZdF2Wn14PdwY0ijI72ygtGDnYv9q3vFl";
...
(function () {
  var _initialLoad = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var URL, response, breeds;
...
function _handleSelection() {
  _handleSelection = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var selectedBreed, url, breedImagesResponse, breedImages, breedInfo;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          selectedBreed = this.value;
          url = "/images/search?limit=30&breed_ids=".concat(selectedBreed);
          _context2.next = 4;
          return _axios.default.get(url, {
            onDownloadProgress: updateProgess
          });
        case 4:
          breedImagesResponse = _context2.sent;
          breedImages = breedImagesResponse.data;
          ...
          breedInfo = structuredClone(breedImages[0]["breeds"][0]);
...
function populateBreedInfo(breedData) {
  ...
  document.getElementById("breed-weight").textContent = "".concat(breedData.weight.imperial, " lbs (").concat(breedData.weight.metric, " kg)");
  document.getElementById("breed-energy").textContent = "".concat(breedData.energy_level, "/5");
  document.getElementById("breed-affection").textContent = "".concat(breedData.affection_level, "/5");
  document.getElementById("breed-grooming").textContent = "".concat(breedData.grooming, "/5");
  document.getElementById("breed-child-friendly").textContent = "".concat(breedData.child_friendly, "/5");
  document.getElementById("breed-dog-friendly").textContent = "".concat(breedData.dog_friendly, "/5");
  document.getElementById("breed-stranger-friendly").textContent = "".concat(breedData.stranger_friendly, "/5");
  document.getElementById("breed-vocalization").textContent = "".concat(breedData.vocalisation, "/5");
  document.getElementById("breed-temperament").textContent = breedData.temperament;
  document.getElementById("breed-health-issues").textContent = "".concat(breedData.health_issues, "/5");
  document.getElementById("breed-hypoallergenic").textContent = breedData.hypoallergenic ? "Yes" : "No";

  // Set links only if they exist
  var links = [{
    id: "cfa-url",
    url: breedData.cfa_url
  }, {
    id: "vca-url",
    url: breedData.vcahospitals_url
  }, {
    id: "vetstreet-url",
    url: breedData.vetstreet_url
  }, {
    id: "wikipedia-url",
    url: breedData.wikipedia_url
  }];
...
_axios.default.interceptors.response.use(function (response) {
  console.log("Delay in getting a response; ".concat(Date.now() - startTime, " ms"));
...
function updateProgess(ProgressEvent) {
  ...
  var percentage = total ? Math.floor(loaded / total * 100) : null;
  console.log("Download progress: ".concat(percentage));
...
function _favourite() {
  _favourite = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(imgId) {
    var url_fav, new_fav_id, resp, response;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          // your code here
          url_fav = "/favourites?limit=1&image_id=".concat(imgId);
          _context3.next = 3;
          return _axios.default.get(url_fav);
        case 3:
          new_fav_id = _context3.sent;
          if (!(new_fav_id.data.length === 1)) {
            _context3.next = 10;
            break;
          }
          _context3.next = 7;
          return _axios.default.delete("/favourites/".concat(new_fav_id.data[0]['id']));
        case 7:
          resp = _context3.sent;
...
function _getFavourites() {
  _getFavourites = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(event) {
    var favourites, fav_data, fav_images;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 3:
          ...
          fav_data = favourites.data;
          fav_images = []; // here we arsing the resulat array objct returned to create ana rray of objects with only the images data 
          fav_data.forEach(function (element) {
            //copy the imag obj  if not empty and push it to fav
            if (Object.keys(element).length > 1) {
              var temp = structuredClone(element.image);
...
function buildCarousel(arrImg) {
  ...
  arrImg.forEach(function (element) {
    ...
    var carouselElement = Carousel.createCarouselItem(element.url, "", element.id);
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","usingaxios.js"], null)
//# sourceMappingURL=/usingaxios.228433f9.js.map